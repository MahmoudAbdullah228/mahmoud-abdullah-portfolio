...
- **Projects gallery** with 4 real-world project showcases
...
| JavaScript (Vanilla) | Cursor effects, scroll animations           |
...
3. **Projects** — 4 featured projects with descriptions, tags, and GitHub links
...
| Project          | Tech                        | Link                                                                      |
| ---------------- | --------------------------- | ------------------------------------------------------------------------- |
| Stack Overlord   | React, TypeScript, Tailwind | [GitHub](https://github.com/MahmoudAbdullah228/StackOverLord_Store)       |
| Fior Flower Shop | HTML5, CSS3, Bootstrap      | [GitHub](https://github.com/MahmoudAbdullah228/Fior-Flower-Shop)          |
| Leon Agency      | HTML5, CSS3                 | [GitHub](https://github.com/MahmoudAbdullah228/HTML_And_CSS_Template_One) |
| Weather App      | HTML, CSS, JS, REST API     | [GitHub](https://github.com/MahmoudAbdullah228/Weather-App)               |
...
- **CV:** [View on Google Drive](https://drive.google.com/file/d/1BFt0sI17NEZaabPG49BSN-pYrZXu47mI/view)
